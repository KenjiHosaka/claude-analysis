...
interface MemberSkillRankingProps {
  data: MemberDetailAggregate["skillRanking"];
}

export function MemberSkillRanking({ data }: MemberSkillRankingProps) {
  if (data.length === 0) {
    return (
      <Card>
        <CardHeader>
              ...
              <Tooltip
                content={({ active, payload }) => {
                  ...
                  const entry = payload[0]
                    .payload as MemberDetailAggregate["skillRanking"][number];
                  return (
